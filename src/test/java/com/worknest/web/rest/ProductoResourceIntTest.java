...
public class ProductoResourceIntTest {
    ...
    private static final String DEFAULT_CBARRAS = "AAAAAAAAAAAAA";
    private static final String UPDATED_CBARRAS = "BBBBBBBBBBBBB";
    ...
    private static final Float DEFAULT_PCOMPRA = 1F;
    private static final Float UPDATED_PCOMPRA = 2F;

    private static final Float DEFAULT_PVENTA = 1F;
    private static final Float UPDATED_PVENTA = 2F;
    ...
    public static Producto createEntity(EntityManager em) {
        Producto producto = new Producto()
            .cbarras(DEFAULT_CBARRAS)
            .nombre(DEFAULT_NOMBRE)
            .descripcion(DEFAULT_DESCRIPCION)
            .cantidad(DEFAULT_CANTIDAD)
            .pcompra(DEFAULT_PCOMPRA)
            .pventa(DEFAULT_PVENTA);
        return producto;
    }
    ...
    public void createProducto() throws Exception {
        ...
        assertThat(testProducto.getCbarras()).isEqualTo(DEFAULT_CBARRAS);
        ...
        assertThat(testProducto.getPventa()).isEqualTo(DEFAULT_PVENTA);
    }
    ...
    @Test
    @Transactional
    public void checkCbarrasIsRequired() throws Exception {
        int databaseSizeBeforeTest = productoRepository.findAll().size();
        // set the field null
        producto.setCbarras(null);
    ...
    @Test
    @Transactional
    public void checkPventaIsRequired() throws Exception {
        int databaseSizeBeforeTest = productoRepository.findAll().size();
        // set the field null
        producto.setPventa(null);
    ...
    public void getAllProductos() throws Exception {
        ...
        restProductoMockMvc.perform(get("/api/productos?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].cbarras").value(hasItem(DEFAULT_CBARRAS.toString())))
            .andExpect(jsonPath("$.[*].nombre").value(hasItem(DEFAULT_NOMBRE.toString())))
            .andExpect(jsonPath("$.[*].descripcion").value(hasItem(DEFAULT_DESCRIPCION.toString())))
            .andExpect(jsonPath("$.[*].cantidad").value(hasItem(DEFAULT_CANTIDAD)))
            .andExpect(jsonPath("$.[*].pcompra").value(hasItem(DEFAULT_PCOMPRA.doubleValue())))
            .andExpect(jsonPath("$.[*].pventa").value(hasItem(DEFAULT_PVENTA.doubleValue())));
    }
    ...
    public void getProducto() throws Exception {
        ...
        restProductoMockMvc.perform(get("/api/productos/{id}", producto.getId()))
            ...
            .andExpect(jsonPath("$.cbarras").value(DEFAULT_CBARRAS.toString()))
            .andExpect(jsonPath("$.nombre").value(DEFAULT_NOMBRE.toString()))
            .andExpect(jsonPath("$.descripcion").value(DEFAULT_DESCRIPCION.toString()))
            .andExpect(jsonPath("$.cantidad").value(DEFAULT_CANTIDAD))
            .andExpect(jsonPath("$.pcompra").value(DEFAULT_PCOMPRA.doubleValue()))
            .andExpect(jsonPath("$.pventa").value(DEFAULT_PVENTA.doubleValue()));
    }
    ...
    public void updateProducto() throws Exception {
        ...
        updatedProducto
            .cbarras(UPDATED_CBARRAS)
            .nombre(UPDATED_NOMBRE)
            .descripcion(UPDATED_DESCRIPCION)
            .cantidad(UPDATED_CANTIDAD)
            .pcompra(UPDATED_PCOMPRA)
            .pventa(UPDATED_PVENTA);
        ...
        Producto testProducto = productoList.get(productoList.size() - 1);
        assertThat(testProducto.getCbarras()).isEqualTo(UPDATED_CBARRAS);
        ...
        assertThat(testProducto.getPventa()).isEqualTo(UPDATED_PVENTA);
    }
